...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datos.add(new Alumno("Daniel","Garcia","2º","DAM"));
        datos.add(new Alumno("Guille","Nuez","2º","DAM"));
        datos.add(new Alumno("Julio","Garcia","2º","DAM"));


        for(int i=0; i<50; i++)
            datos.add(new Alumno("Nombre: " + i, "Apellido: " + i, "Clase: "+i, "Curso: "+i));
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                datos.add(1, new Alumno("Nuevo Alumno","Nuevo Apellido","Nuevo curso", "Nueva curso del Alumno"));
